...
<fieldset>
	...
	<select name="zoom_level">
        ...
        <option value="14"<?php selected($_POST['zoom_level'],'14') ?>>14</option>
         <option value="15"<?php selected($_POST['zoom_level'],'15') ?>>15</option>
          <option value="16"<?php selected($_POST['zoom_level'],'16') ?>>16</option>
           <option value="17"<?php selected($_POST['zoom_level'],'17') ?>>17</option>
            <option value="18"<?php selected($_POST['zoom_level'],'18') ?>>18</option>
             <option value="19"<?php selected($_POST['zoom_level'],'19') ?>>19</option>
    </select>
