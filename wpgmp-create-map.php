...
<fieldset>
    ...
    <div class="col-md-9">
	<input type="text" name="map_title" value="<?php echo $_POST['map_title']; ?>" class="create_map form-control" />
   ...
   <div class="col-md-7">
	<input type="text" name="map_width" value="<?php echo $_POST['map_width']; ?>" class="create_map form-control" />
   ...
   <div class="col-md-7">
	<input type="text" name="map_height" value="<?php echo $_POST['map_height']; ?>" class="create_map form-control" />
...
<fieldset>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="control[pan_control]" value="false"<?php checked($_POST['control']['pan_control'],'false') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="control[zoom_control]" value="false"<?php checked($_POST['control']['zoom_control'],'false') ?>/>
   ...
   <div class="col-md-7">
<p class="description">	<input type="checkbox" name="control[map_type_control]" value="false"<?php checked($_POST['control']['map_type_control'],'false') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="control[scale_control]" value="false"<?php checked($_POST['control']['scale_control'],'false') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="control[street_view_control]" value="false"<?php checked($_POST['control']['street_view_control'],'false') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="control[overview_map_control]" value="false"<?php checked($_POST['control']['overview_map_control'],'false') ?>/>
...
<fieldset>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="street_view_control[street_control]" class="street_view_toggle" value="true"<?php checked($_POST['street_view_control']['street_control'],'true') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="street_view_control[street_view_close_button]" value="true"<?php checked($_POST['street_view_control']['street_view_close_button'],'true') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="street_view_control[links_control]" value="false"<?php checked($_POST['street_view_control']['links_control'],'false') ?>/>
   ...
   <div class="col-md-7">
	<p class="description"><input type="checkbox" name="street_view_control[street_view_pan_control]" value="false"<?php checked($_POST['street_view_control']['street_view_pan_control'],'false') ?>/>
