...
Description: Easiest way to display Markers on Locations by Address on Google Map. Plugin based on latest google api version so you need to register for API KEY so seemlessly you can transfer your work on any number of websites.
Author: flippercode
Version: 1.0.0
